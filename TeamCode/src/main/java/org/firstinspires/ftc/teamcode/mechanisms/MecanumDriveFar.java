...
@Config
public final class MecanumDriveFar {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveFar.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveFar.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveFar.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveFar.this.rightFront));
    ...
    public MecanumDriveFar(HardwareMap hardwareMap, Pose2d pose) {
    ...
    public Action intakeOn() {
        return new InstantAction(() -> {
            intakeTransfer.setPower(1);//0.6
            intakeServo.setPower(-0.2);
        });
    }
    public Action intakeSSOn() {
        return new InstantAction(() -> {
            intakeTransfer.setPower(1);//0.5
